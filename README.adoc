...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/tech-practices-code-bcn-es
//
// MANDATORY.
:_url: https://ethical-digital-standards-bcn.netlify.com/es/tech-practices/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Código de Prácticas Tecnológicas
//
...
:_summary: Conjunto de directrices para implementar proyectos tecnológicos con estándares abiertos y gestión ética de los datos
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: estándares ésticos digitales, derechos digitales, barcelona, ayuntamiento, código prácticas tecnológicas
//
...
:_copyleft: Barcelona City Council y los autores del documento
//
